<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="java.util.*, com.mom.DAO.*, com.mom.model.*"%>
...
<body>
	...
	<nav>
	<ul>
		<li class="home-button btn-info "><a href="AdminDashboard.jsp">
				Home</a></li>
		<li><center>
				<h3 class="text-centeremp">EMPLOYEE DETAILS</h3>
			</center></li>
		<div style="float: right; margin: 2%; color: lightblue;"
			class="text-info">
			<strong>Number of Employees : <%=list.size()%></strong>
		</div>
			...
			<table
				...
				<tbody>
					...
					<TR>
						...
						<td class="pt-3-half"><span class="table-edit"><a
								class="btn  btn-rounded btn-sm my-0 font btn btn-info">Edit</a></span></td>
						<td class="pt-3-half"><span class="table-remove"><a
								class="btn btn-rounded btn-sm my-0 font btn btn-danger" href='#'>Delete</a></span></td>
						<%
							}
						%>
					</TR>
					...
					<form action="Editservlet" method="post">
						<div class="modal-body mx-4">
							...
							<div class="md-form pb-3">
								...
								<input type="email" name="Form_email" id="Form-Email"
							...
							<div class="md-form pb-3">
								...
								<select class="form-control" name="Form_desi" id="Form-desi"
									class="form-control validate">
							...
							<label data-error="wrong" data-success="right" for="Form-pass1">Department
								ID</label>
							<div class="md-form pb-3">
								<select class="form-control" name="Form_dept" id="Form-depa"
									class="form-control validate">
